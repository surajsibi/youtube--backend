...
const changeCurrentPassword = dbWrapper(async (req, res) => {
...
const getCurrentUser = dbWrapper(async (req, res) => {
  return res
    .status(200)
    .json(
      new ApiResponse(
        200, req.user, "current user fetched successfull"
      )
    )
})
...
const updateUserAvatar = dbWrapper(async (req, res) => {
  ...
  if (!user) {
    throw new ApiError(400, "cant update avatar in db")
  }
...
const updateUserCoverImage = dbWrapper(async (req, res) => {
  ...
  if (!user) {
    throw new ApiError(400, "cant update cover image in db")
  }
...
const getUserChannelProfile = dbWrapper(async (req, res) => {
...
const getWatchHistory = dbWrapper(async (req, res) => {
